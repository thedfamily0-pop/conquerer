...
interface Props { activeTab: AppTab; onSelectTab: (tab: AppTab) => void; onOpenParentPortal: () => void; unreadAlertCount: number; nomiName: string; }
export function MobileBottomNav({ activeTab, onSelectTab, onOpenParentPortal, unreadAlertCount, nomiName }: Props) {
